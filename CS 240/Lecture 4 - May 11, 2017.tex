...
\lecture{4}{May 11th, 2017}{Taylor Smith}{Harsh Mistry}
 ...
 \begin{itemize}
 \item Insert : inserting a item tagged with a priority 
 \item deleteMax : removing the items of highest priority
 \end{itemize}
  \end{definition}

 
 \subsection{Realizations of Priority Queues}
 \textbf{Attempt 1 : } Using a unsorted array or unsorted link list
 \begin{itemize}
 \item insert: O(1) 
 \item deleteMax : O(n)
 \end{itemize}
 \textbf{Attempt 2 :} Using a sorted array or link-list
 \begin{itemize}
 \item Insert : O(n)
 \item deleteMax : O(1)
 \end{itemize}
